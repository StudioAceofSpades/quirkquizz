...
add_filter('template_include', function($template) {
    return createTemplateLoader('page-id=', 'confirmation-page.php', $template);
});
​
...
​​
    ...
    $searchStringExist = strpos($request, $searchString) !== false;
    $parentExist = false;
​
...
​
        return locate_template($templateName);
    }
​
    return $currTemplate;
}
